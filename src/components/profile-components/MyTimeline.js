...
import { deletePost, undoDeletePost } from '../../Services/Actions/SocialFeed/getAllUserPostsAction';
                            ...
                            <div className="col-8">
                                <div className="row">
                                    <div className="col-2 p-0">
                                        <img src='/assets/images/Icons/deleted.png' className='iw-20' alt='delete' />
                                    </div>
                                    <div className="col-10 p-0">
                                        <h2 className="font-weight-bold text-white">Post Deleted</h2>
                                    </div>
                                    <h6 className='text-white p-0'>Slide Undo to recover post within 10 sec.</h6>
                                </div>
                            </div>
                        ...
                        <div className="page-content">
                            ...
                            <div className="content-center">
                                ...
                                <div className="post-panel section-t-space">
                                    ...
                                    >
                                        {
                                            allPostsByUserId?.rows && allPostsByUserId?.rows?.map((userPosts) => {
                                                return (
