...
const CarouselWebsiteLink = ({ typeId, subTypeId, adTypeData }) => {
  // Snackbar Code
                        ...
                        {i !== 0 && (
                          <p
                            ...
                            onClick={() =>
                              setMediaData(
                                mediaData.filter(
                                  (med, ind) => ind !== mediaData.length - 1
                                )
                              )
                            }
                          >
...
export default CarouselWebsiteLink;
