    ...
    <>
      ...
      <div className="row">
        <div className="col-lg-6 preview-right">
          ...
          <div
            className="bg-white"
            style={{ display: accord === 1 ? "block" : "none" }}
          >
                  ...
                  <div className="profile">
                    <div className="media d-flex mb-1">
                      ...
                      <div className="media-body ml-2">
                        ...
                        <h6>
                          <span className="color-grey">Sponsored</span>
                        </h6>
                      </div>
                    </div>
                  </div>
                ...
                <div className="post-details">
                  ...
                  <div className="detail-box">
                    <h5 className="tag">
                      ...
                      thankless work of keeping the office up to date on pop
                      culture.{" "}
                    </h5>
                  </div>
          ...
          <div
            className="bg-white"
            style={{ display: accord === 2 ? "block" : "none" }}
          >
                ...
                <div className="post-details-new col-lg-12">
                  <div className="row">
                    <div className="recomandation-display-block col-lg-7 p-1">
                      ...
                      <div>
                        ...
                        <div className="preview-detail-small">
                          ...
                          <p className="preview-small preview-know">
                            Know more
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="recomandation-display-block col-lg-5 p-1">
                      <div className="preview-fake-img"></div>
          ...
          <div
            className="bg-white"
            style={{ display: accord === 3 ? "block" : "none" }}
          >
            ...
            <div className="post-panel-new">
              <div className="post-wrapper col-grid-box">
                ...
                <div className="preview-more">visit all groups</div>
              </div>
            </div>
          </div>
          ...
          <div
            className="bg-white"
            style={{ display: accord === 4 ? "block" : "none" }}
          >
            ...
            <div className="post-panel-new">
              <div className="post-wrapper col-grid-box">
                ...
                <div className="preview-more">visit all Bizpages</div>
              </div>
            </div>
          </div>
          ...
          <div
            className="bg-white"
            style={{ display: accord === 5 ? "block" : "none" }}
          >
                    ...
                    <div className="recomandation-display-block col-lg-5 p-1">
                      <div className="preview-grp-post">
                        ...
                        <div className="mp-overword">
                          <div className="detail-box">
                            <h4 className="small-preview-heading">
                              This award goes...
                            </h4>
                          </div>
                          <div className="preview-detail-small">
                            <p className="small-preview-small">Sponsored</p>
                            <p className="small-preview-small preview-know">
                              Know more
                            </p>
                          </div>
                        </div>
          ...
          <div
            className="bg-white"
            style={{ display: accord === 6 ? "block" : "none" }}
          >
        ...
        <div className="col-lg-6 preview-right p-0">
          <div className="col-lg-12 p-0">
            <div className="row">
              <div
                className="col-lg-6 col-6 small-padding-fake"
                onClick={() => {
                  setAccord(1);
                }}
              >
                  ...
                  <div className="post-panel-new">
                    <div className="post-wrapper col-grid-box">
                      ...
                      <div className="post-details">
                        ...
                        <div className="detail-box">
                          <h5 className="small-tag">
                            This award goes to the coworker who’s always doing
                            the thankless work of keeping the office up to date
                            on pop culture.{" "}
                          </h5>
                        </div>
                        <div className="small-Why-this-ad">
                          <p>Why this Ad?</p>
                          <img
                            src="/assets/images/adIcon/Share-icon.png"
                            alt=""
                          />
                        </div>
                      </div>
                      ...
                      <div className="post-details col-lg-12 col-12">
                        <div className="row">
                          ...
                          <div className="recomandation-display-block col-lg-5 col-6 p-1">
                            <div className="small-preview-fake-img"></div>
                            <div className="fake-line mt-2">
                              <div className="fake-heading"></div>
                              <div className="fake-know-main mt-2">
                                <div className="fake-p"></div>
                ...
                <div className="small-bg-main">
                  <div className="post-panel-new">
                    <div className="post-wrapper col-grid-box">
                          ...
                          <div className="recomandation-display-block col-lg-10 col-9 p-1">
                            <div className="small-preview-main-border">
                              ...
                              <div>
                                ...
                                <div className="preview-detail-small">
                                  <p className="small-preview-small">
                                    Sponsored
                                  </p>
                                  <p className="small-preview-small preview-know">
                                    Know more
                      ...
                      <div className="small-preview-more">visit all groups</div>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="post-details col-lg-12 col-12 p-1">
                        <div className="row">
                          <div className="recomandation-display-block col-lg-7 col-7 p-1">
                            ...
                            <div>
                              <div className="detail-box">
                                <h5 className="small-preview-heading">
                                  Sponsored
                                </h5>
                              </div>
                              <div className="detail-box mb-2">
                          ...
                          <div className="recomandation-display-block col-lg-5 col-5 p-1">
                            <div className="smalls-preview-main-border">
                              <div className="smalls-preview-fake-img"></div>
                              <div className="fake-line mt-2">
                                <div className="fake-heading"></div>
                                <div className="fake-know-main mt-2">
                                  <div className="fake-p"></div>
